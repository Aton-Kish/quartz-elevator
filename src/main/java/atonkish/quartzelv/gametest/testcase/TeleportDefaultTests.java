...
public class TeleportDefaultTests implements CustomTestMethodInvoker {
    ...
    @GameTest
    public void playerDoesNotTeleportUpFromQuartzElevatorToQuartzElevator(TestContext context) {
        this.playerTeleportUpTest(context,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                17,
    ...
    @GameTest
    public void playerDoesNotTeleportDownFromQuartzElevatorToQuartzElevator(TestContext context) {
        this.playerTeleportDownTest(context,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                17,
    ...
    @GameTest
    public void playerDoesNotTeleportUpFromSmoothQuartzElevatorToSmoothQuartzElevator(TestContext context) {
        this.playerTeleportUpTest(context,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                65,
    ...
    @GameTest
    public void playerDoesNotTeleportDownFromSmoothQuartzElevatorToSmoothQuartzElevator(TestContext context) {
        this.playerTeleportDownTest(context,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                65,
    ...
    @GameTest
    public void playerDoesNotTeleportUpFromQuartzElevatorToSmmoothQuartzElevator(TestContext context) {
        this.playerTeleportUpTest(context,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                16,
    ...
    @GameTest
    public void playerDoesNotTeleportDownFromQuartzElevatorToSmmoothQuartzElevator(TestContext context) {
        this.playerTeleportDownTest(context,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                16,
    ...
    @GameTest
    public void zombieTeleportUpFromQuartzElevatorToQuartzElevator(TestContext context) {
    ...
    @GameTest
    public void zombieTeleportUpFromSmoothQuartzElevatorToSmoothQuartzElevator(TestContext context) {
        this.mobTeleportUpTest(context,
                EntityType.ZOMBIE,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
    ...
    @GameTest
    public void slimeTeleportUpFromQuartzElevatorToQuartzElevator(TestContext context) {
        this.mobTeleportUpTest(context,
                EntityType.SLIME,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
                ModBlocks.QUARTZ_ELEVATOR_BLOCK,
    ...
    @GameTest
    public void slimeTeleportUpFromSmoothQuartzElevatorToSmoothQuartzElevator(TestContext context) {
        this.mobTeleportUpTest(context,
                EntityType.SLIME,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
    ...
    @GameTest
    public void magmaCubeTeleportUpFromQuartzElevatorToQuartzElevator(TestContext context) {
        this.mobTeleportUpTest(context,
    ...
    @GameTest
    public void magmaCubeTeleportUpFromSmoothQuartzElevatorToSmoothQuartzElevator(TestContext context) {
        this.mobTeleportUpTest(context,
                EntityType.MAGMA_CUBE,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
                ModBlocks.SMOOTH_QUARTZ_ELEVATOR,
